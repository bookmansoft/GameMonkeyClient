 ...
 * 和舞台对应的Mediator
 */
class BuddhaManagerMediator extends puremvc.Mediator implements puremvc.IMediator {
    /**
     * 和指定UI建立关联，为UI上的控件订阅界面事件，并提供对应的响应函数
     */
    public constructor(viewComponent: any) {
        super(ViewerName.BuddhaManagerMediator, viewComponent);
     ...
     * 返回关联的UI单元
     */
    public get main(): BuddhaManagerWindow {
        return <BuddhaManagerWindow><any>(this.viewComponent);
    }
}